...
namespace OpenAC.Net.Sat.Demo
{
    public class OpenConfig
    {
        ...
        internal OpenConfig(Configuration config)
        {
            this.config = config;
        }
        ...
        public static OpenConfig CreateOrLoad(string fileName = "acbr.config")
        {
            ...
            return new OpenConfig(ConfigurationManager.OpenMappedExeConfiguration(configFileMap, ConfigurationUserLevel.None));
        }
